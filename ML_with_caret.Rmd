...
First we fit a gbm model on the training data. Note that the gbm function does not allow factor "class" variables.
...
It looks like a toss up between the Random Forest and GBM. The Random Forest posts a slightly higher median value but shows greater variablility. 
